##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.11.2] date: [Sat Nov 09 10:46:27 CST 2024] 
##########################################################################################################################
...
-IFreeRTOS/Source/Portable/ARM_CM4F \
-Iapp/include
...
all: $(BUILD_DIR)/$(TARGET).elf $(BUILD_DIR)/$(TARGET).hex $(BUILD_DIR)/$(TARGET).bin
	$(DP) $(BUILD_DIR)/$(TARGET).elf -xd > $(BUILD_DIR)/$(TARGET).elf.txt
...
#######################################
flash: all
	openocd -f ./stlink.cfg -f ./stm32f4x.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"
